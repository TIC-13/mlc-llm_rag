...
def main(apk_path: Path, package_output_path: Path):
    ...
    device_weihgt_dir = "/storage/emulated/0/Android/data/ai.luxai.mlcchat/files/"
    ...
    for model_weight_dir in (package_output_path / "bundle").iterdir():
        if model_weight_dir.is_dir():
            ...
            src_path = dst_path
            dst_path = "/storage/emulated/0/Android/data/ai.luxai.mlcchat/files/"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="The path to generated ReggaeLLM apk file.",
    )
    parser.add_argument(
        "--package-output-path",
        type=Path,
